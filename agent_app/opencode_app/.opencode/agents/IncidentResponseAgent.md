---
description: Incident response orchestration agent that executes a single approved incident-response skill and only queries approved AI4X data through ai4x_ai4x_query.
mode: primary
temperature: 0.1
permission:
  edit: deny
