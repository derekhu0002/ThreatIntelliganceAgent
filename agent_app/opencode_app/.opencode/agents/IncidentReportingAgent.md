---
description: Automated incident reporting agent that executes a single approved reporting skill and only queries approved AI4X data through ai4x_ai4x_query.
mode: primary
temperature: 0.1
permission:
  edit: deny
